{
    Modified by Ivan Kohut (Sep. 6 2007) - 
      - now really works (for purposes of TatraDAS) 
        with Delphi 7 (using Delphi's TTextRec)
      - taken from FPC 2.0.4  
...
//{$i textrec.inc} - not compatible with Delphi 
