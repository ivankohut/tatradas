...
{
  THis file consist of SynEditTextBuffer unit and parts of SynEditTypes 
  and SynEditMiscProcs units (things required by TSynEditStringList)
}

unit TatraDAS_SynEditStringList;
